export const tr = {
  ...
  basket: {
    ...
    custom: "Özel",
    resetToPreset: "Hazır sepete dön",
    unsavedHint: "Kaydedilmemiş özel ağırlıklar; ekran değişince ve yenilemede korunur.",
    reference: "referans (gri kesikli)",
    diff: "fark",
    points: "puan",
    coveredShare: "kapsanan ağırlık payı",
    fixedPreset: "hazır sepet",
    saved: "kaydedildi",
    deleted: "silindi",
